...
<body id="page-top">
    ...
    <div class="card shadow">
        <h3 class="m-0 font-weight-bold text-info">Tanggapan</h3>
        ...
        <div class="card-body">
            ...
            <form action="simpan_tanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group cols-sm-6">
                    <label class="m-0 font-weight-bold text-dark">ID Pengaduan</label>
                    <input type="text" name="id_pengaduan" value="<?php echo $_GET['id']; ?>" class="form-control" readonly>
                </div>

                <div class="form-group cols-sm-6">
                    <label class="m-0 font-weight-bold text-dark">Tanggal Tanggapan</label>
                    <input type="text" name="tgl_tanggapan" value="<?php echo date('Y-m-d'); ?>" class="form-control" readonly>
                </div>

                <div class="form-group cols-sm-6">
                    <label class="m-0 font-weight-bold text-dark">Tulis Tanggapan</label>
                ...
                <input type="submit" class="btn btn-info btn-user" value="Tanggapi">
            </form>
        </div>
    </div>
