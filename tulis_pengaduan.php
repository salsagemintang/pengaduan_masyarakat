...
<body id="page-top">
    ...
    <div class="card shadow">
        <div class="card-header">
            <h3 class="m-0 font-weight-bold text-info">Tulis Pengaduan</h3>
        </div>
        <div class="card-body">
            <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group cols-sm-6">
                    <label class="m-0 font-weight-bold text-dark">NIK</label>
                ...
                <div class="form-group cols-sm-6">
                    <label class="m-0 font-weight-bold text-dark">Unggah Foto</label>
                    <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png, .gif">
                    <font color="#669999"> *tipe yang bisa di upload adalah : .jpg, .jpeg, .png, .gif </font>
                </div>
